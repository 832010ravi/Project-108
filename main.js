...
function startClassification() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/2mxdE_Tb5/model.json', modelReady);
...
function gotResults(error, results) {
 if(error) {
    ...
    var img = document.getElementById("animals_image");
